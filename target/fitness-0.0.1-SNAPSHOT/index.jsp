...
<div class="wrap">
    ...
    <div class="head">
     	...
     	<div class="login"><a href="${pageContext.request.contextPath }/login.jsp">登录</a>丨<a href="${pageContext.request.contextPath }/register.jsp">注册</a> 
    	</div>
    	<div id="login1" style="display: none;" class="login"><font color="#3AC0F5"><%=session.getAttribute("opname")%>,您已经登陆</font>
    	</div>
    </div>
