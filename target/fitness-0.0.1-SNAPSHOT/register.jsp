...
<script type="text/javascript">
	...
	$(function(){
  	...
  	$('#sub').click(function(){
    	...
    	if(username.length == 0 || password.length == 0 || qqnum.length == 0){
	...
	<div class="wrap">
		<div class="back">
			...
			<div class="content">
				...
				<input type="text" class="text"  placeholder="请输入密码" name="userpssword"  id="userpssword"/> 
			<input type="text" class="text"  placeholder="QQ号" name="user_qq_number"  id="user_qq_number" /> 		
					<input type="button" class="button" value="注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;册" id="sub"  />
			</div>
		</div>
	</div>
